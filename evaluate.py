...
image_data_test_dir = './stratified_imagedata/test'

feature_data_test_dir = './stratified_featuredata/test'
...
feature_input_dim = combined_dataset_test.feature_dataset[0][0].shape[1]
print(feature_input_dim)

num_classes = len(combined_dataset_test.label_encoder.classes_)
print(num_classes)
...
class_names = ['ACC', 'BLCA', 'BRCA', 'CESC', 'CHOL', 'COAD', 'DLBC', 'ESCA', 'GBM', 'HNSC', 'KICH', 'KIRC',
