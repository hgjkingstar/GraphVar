...
image_data_train_dir = './stratified_imagedata/train'
image_data_test_dir = './stratified_imagedata/validation'
feature_data_train_dir = './stratified_featuredata/train'
feature_data_test_dir = './stratified_featuredata/validation'
